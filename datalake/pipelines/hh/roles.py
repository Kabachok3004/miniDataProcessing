"""Полный справочник профессиональных ролей HH (id -> название).

Сгенерировано из GET /professional_roles.
PROFESSIONAL_ROLES — все роли. SEARCH_DEPRECATED — те, по которым поиск вакансий
отключён (исключаются из fan-out вакансий, см. extract.VACANCY_ROLES).
"""

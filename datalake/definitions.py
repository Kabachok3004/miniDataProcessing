...
from datalake.jobs.hh import (
    hh_dictionaries_job,
    hh_dictionaries_schedule,
    hh_vacancies_job,
    hh_vacancies_schedule,
)
...
defs = Definitions(
    ...
    jobs=[cbr_job, hh_dictionaries_job, hh_vacancies_job],
    schedules=[cbr_schedule, hh_dictionaries_schedule, hh_vacancies_schedule],
)
